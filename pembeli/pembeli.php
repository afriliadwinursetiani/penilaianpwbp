...
<div class="container mt-4">
    ...
    <a href="tambahpembeli.php" class="btn btn-pink mb-3">+ Tambah Pembeli</a> <form method="get" class="mb-3 d-flex">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <!-- tombol hapus -->
                <a href="hapus.php?tabel=pembeli&id=<?= $row['id_pembeli']; ?>&kolom=id_pembeli" 
                   class="btn btn-danger btn-sm" 
                   onclick="return confirm('Yakin hapus pembeli ini?')">Hapus</a>
            </td>
        </tr>
        <?php } ?>
    </table>
