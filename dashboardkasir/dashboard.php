...
// kalau bukan admin/owner → tendang
...
<div class="container my-4">
  <h3 class="mb-4 fw-bold text-secondary">Dashboard Kasir</h3>
  <div class="row g-3">
    <div class="col-md-4">
      <div class="card p-3 shadow-sm bg-pembeli">
        <h5>Total Pembeli</h5>
        <h2><?= $total_pembeli ?></h2>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card p-3 shadow-sm bg-barang">
        <h5>Total Barang</h5>
        <h2><?= $total_barang ?></h2>
      </div>
    </div>
    <div class="col-md-4">
      <div class="card p-3 shadow-sm bg-penjualan">
